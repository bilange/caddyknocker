...
* `TOTP-Secret`: This is a TOTP secret that ideally only you should know, as it serves as your "password" so to speak to authenticate yourself on the `/knock` endpoint. You can use https://totp.danhersam.com/ to generate a new TOTP secret, and paste the secret on this line of configuration (and as well as in your TOTP manager of choice, of course).
